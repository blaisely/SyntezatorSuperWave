...
public:
    ...
    modMatrixGUI(SuperWaveSynthAudioProcessor&);
    ...
    void setUpLayout(juce::FlexBox& box,juce::ComboBox& item1,customSlider& item2,juce::ComboBox& item3);

private:
    comboBoxLookAndFeel comboLook;
    const int itemWidth = 105;
