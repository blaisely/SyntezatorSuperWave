...
public:
    ...
    struct chainSettings {
        ...
        lfo2freq{0.0f},lfo2depth{0.0f},modIntensity1{0.f},modIntensity2{0.f},modIntensity3{0.f},modIntensity4{0.f},modIntensity5{0.f},pulseWidthOsc1{0.0f},
        ...
        lfoReset2{0},lfoReset3{0},reset{0},lfoNumber{1};
    };
